...
//        dp[0]=1;
//        for(int i=1; i<l+1; i++){
//            // Note here j has to include 0 because it needs the part to handle nums[i-1]==0, but it doesn't have to be
//            // like below, because nums[i-1]==0 is handled in general case
...
//    }
    ...
    public int findTargetSumWays(int[] nums, int S) {
        ...
        dp[0][0]=1;
        // nums[i-1]==0 doesn't need to be handled specifically like below as it's handled in general case
        // for(int i=1; i<l+1; i++){
...
//                    result[0]++;
//                } else{
//                    // If it's equal to 0, + and - both will work
//                    result[0]+=2;
//                }
//            }
//            return;
