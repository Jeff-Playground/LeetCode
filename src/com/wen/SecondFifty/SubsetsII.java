...
//    }
    ...
    public List<List<Integer>> subsetsWithDup(int[] nums) {
        ...
        Arrays.sort(nums);
        // Use lastSize to determine whether or not start with 0 to make new subsets. If there's a duplicate, it can
        // only start with new subsets generated in the last loop.
        int lastSize=1, last=nums[0];
