...
//        // columnPosition stands for the position on each row
...
//    }
//
//    private static void helper(int upperLimit, int rowLimit, int leftDiagonalLimit, int rightDiagonalLimit, int[] columnPosition, int row, List<List<String>> result) {
//        if(rowLimit!=upperLimit){
//            int availablePos=upperLimit & (~(rowLimit | leftDiagonalLimit | rightDiagonalLimit));
//            while(availablePos>0){
//                // This will make only the first non-zero digit from right to be 1, and is equivalent to
...
//                helper(upperLimit,rowLimit | pos, (leftDiagonalLimit | pos) << 1, (rightDiagonalLimit | pos) >>1, columnPosition, row+1, result);
