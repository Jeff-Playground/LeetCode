...
public class LongestPalindromicSubsequence {
    // dp[i][j] stands for the longest palindromic subsequence for s.substring(i, j+1)
...
//    // dp[i][j] stands for the longest common subsequence for s.substring(0, i+1) and sReverse.substring(0, j+1)
