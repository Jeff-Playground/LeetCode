...
//    // BFS, note introduced array min[][] to avoid wrong pruning during the process. In this case, it's very similar to Dijkstra because node can
//    // only keep travelling in one direction. Normally, Dijkstra works better with weighted graph
//    public int shortestDistance(int[][] maze, int[] start, int[] destination) {
//        if(start[0]==destination[0] && start[1]==destination[1]){
//            return 0;
//        }
